...
/// 1. Initializing essential services like Firebase.
...
Future<void> main() async {
  ...
  // This reads the google-services.json (Android) and GoogleService-Info.plist (iOS)
  // files you added to your project.
